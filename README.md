...
# CoffeeIsWork backend

Used a serverless node.js start project to get going -- info on usage below.
...
More info [here](https://facebook.github.io/jest/docs/en/getting-started.html#content).
